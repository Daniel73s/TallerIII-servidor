...
const {listarvet, addveterinaria, delveterinaria, habveterinaria, asignarpervet, listarvetByCodvet, duenosveterinaria, Countvetrerinarias, updateveterinaria, eliminarpervet, listarvetusu, AbrirCerrarVet, listarvetByAc, modvetapp, listarvetByEstado, ReporteVeterinarias, filtrarVeternarias} = require('../controllers/veterinarias.controller');
...
router.post('/filtrarvet',filtrarVeternarias);
